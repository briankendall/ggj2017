...
color soundForLightColor(int soundColor, int soundAlpha) {
    if (soundColor == SOUND_NONE) {
        return color(0, 0, 0, 0);
    } else if (soundColor == SOUND_RED) {
        return color(255, 0, 0, soundAlpha);
    } else if (soundColor == SOUND_GREEN) {
        return color(0, 255, 0, soundAlpha);
    } else if (soundColor == SOUND_BLUE) {
        return color(0, 0, 255, soundAlpha);
    } else if (soundColor == SOUND_YELLOW) {
        return color(255, 255, 0, soundAlpha);
    } else if (soundColor == SOUND_CYAN) {
        return color(0, 255, 255, soundAlpha);
    } else if (soundColor == SOUND_ORANGE) {
        return color(255, 128, 0, soundAlpha);
    } else if (soundColor == SOUND_PURPLE) {
        return color(128, 0, 128, soundAlpha);
    } else {
        return color(0,0,0,0);
    }
}